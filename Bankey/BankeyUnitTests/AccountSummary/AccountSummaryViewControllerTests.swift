...
//  BankeyUnitTests
//
//  Created by Kirill Sytkov on 12.05.2022.
//
...
class AccountSummaryViewControllerTests: XCTestCase {
    ...
    func testTitleAndMEssageForServerError() throws {
        ...
        XCTAssertEqual("We could not process yuor request. Please try again", titleAndMessage.1)
    }
    ...
    func testAlertFroServerError() throws {
        mockManager.error = NetworkError.serverError
        vc.forceFetchProfile()
        
        XCTAssertEqual("Server Error", vc.errorAlert.title)
        XCTAssertEqual("We could not process yuor request. Please try again", vc.errorAlert.message)
    }
